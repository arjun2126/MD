...
yesBtn.addEventListener("click", () => {
  ...
  question.insertAdjacentHTML('beforeend', '<br>');
  question.insertAdjacentHTML('beforeend', "Melanie, are you the sun? Because you're the only thing that can light up my nights and make my melatonin levels rise.");
